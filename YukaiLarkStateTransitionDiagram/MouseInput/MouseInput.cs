...
public partial class Game1
{
    ...
    private void HandleMouse(KeyboardState keyboard, MouseState mouse)
    {
        ...
        if (leftPressed)
        {
            ...
            if (TryHandleDiagramTabClick(mouse))
            {
                return;
            }
    ...
    private MouseCursor GetMouseCursor(KeyboardState keyboard, MouseState mouse)
    {
        ...
        if (_isFileMenuOpen || _isThemeMenuOpen || _isSubstateLinkMenuOpen || _isColorPaletteOpen || _isExportSelecting || IsEditingLabel || _isEditingDiagramTabName || _isEditingFileName)
        {
